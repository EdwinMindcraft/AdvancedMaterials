...
public class CrystallizerRecipe implements IMachineRecipe {
	 ...
	 * @param outputs : up to 1 elements, can be : {@link String}, {@link Item}, {@link ItemStack}, {@link Block}
	 */
	public CrystallizerRecipe(Object input, Object... outputs) {
		if (input == null) {
		...
		if (outputs.length > 1) {
			AdvancedMaterials.getLogger().severe("Please just read : max 1 outputs... (" + input.toString() + ")");
			throw new NullPointerException("Just stopping registration");
		}
