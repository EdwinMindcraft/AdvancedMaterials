...
public class CentrifugeRecipe implements IMachineRecipe {
	 ...
	 * @param outputs : up to 4 elements, can be : {@link String}, {@link Item}, {@link ItemStack}, {@link Block}
	 */
	public CentrifugeRecipe(Object input, Object... outputs) {
		if (input == null) {
		...
		if (outputs.length > 4) {
			AdvancedMaterials.getLogger().severe("Please just read : max 4 outputs... (" + input.toString() + ")");
			throw new NullPointerException("Just stopping registration");
		}
